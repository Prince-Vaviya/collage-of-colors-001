...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-card hover:-translate-y-0.5 hover:bg-studio-ink/90",
        blue: "bg-studio-blue text-white shadow-card hover:-translate-y-0.5 hover:bg-blue-700",
        outline:
        ...
        whatsapp:
          "bg-[#1FAF62] text-white shadow-card hover:-translate-y-0.5 hover:bg-[#188d50]",
      },
      size: {
        default: "h-11 px-6",
        sm: "h-9 px-4",
